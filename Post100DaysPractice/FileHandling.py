...
# File handling allows Python programs to read, write, and
# manipulate files stored on disk. Python provides built-in functions for working with files.
#------------------------------------------------------------------------------------------------------------------
...
#   Read line	R                       ead one line	                           file.readline()
