...
# String is arguably the most used immutable data types in Python.
# Python provides multiple ways to format strings, including the format() method
# and f-strings (introduced in Python 3.6).
